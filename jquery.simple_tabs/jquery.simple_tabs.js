 ...
 *
 * Вкладка
 * 		должна содержать класс "js-simple-tab" и атрибуты "data-tab-group" и "data-tab-id".
 *
 * Контейнер
 * 		связанный с вкладкой должен иметь класс "js-simple-tab-content" и также содержать атрибуты "data-tab-group" и "data-tab-id" с теми же значениями что и его вкладка.
 *
